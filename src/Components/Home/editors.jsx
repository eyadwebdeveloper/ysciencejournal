...
import AvaniAgarwal from "../../images/team/avani-agarwal.png";
import ArailymTemirkhan from "../../images/team/arailym-temirkhan.png";
...
import AkhmetzhanNurbike from "../../images/team/akhmetzhan-nurbike.png";
    ...
    <React.Fragment>
      <section className="team content">
        ...
        <div className="team-cards">
          ...
          />
          <TeamCard
            frontImage={AvaniAgarwal}
            frontName="Avani Agarwal"
            frontTitle="Editor in Chief"
            frontSocialLinks={[
              {
                url: "https://www.instagram.com/avani89289?igsh=dzIycWJjcDU0ZzB4",
                iconClass: "fa-brands fa-instagram",
              },
              {
                url: "mailto:avanipersonal7@gmail.com",
                iconClass: "fa-solid fa-envelope",
              },
            ]}
            backImage={RadwaAshraf}
            backName="Radwa Ashraf"
            backTitle="Former Editor In Chief"
            backSocialLinks={[
              {
                url: "https://www.facebook.com/radwa197",
                iconClass: "fa-brands fa-facebook",
              },
              { url: "", iconClass: "fa-brands fa-instagram" },
              {
                url: "mailto:radwaashraf576@gmail.com",
                iconClass: "fa-solid fa-envelope",
              },
            ]}
          />
          <TeamCard
            frontImage={ArailymTemirkhan}
            frontName="Arailym Temirkhan"
            frontTitle="Editor in Chief"
            frontSocialLinks={[
              {
                url: "https://www.instagram.com/araileka?igsh=MWVpbGw1aWd2bHRjOQ==",
                iconClass: "fa-brands fa-instagram",
              },
              {
                url: "mailto:t.a.arailym@gmail.com",
                iconClass: "fa-solid fa-envelope",
              },
            ]}
            backImage={MikhaelMounay}
            backName="Mikhael Mounay"
            backTitle="Website Manager"
            backSocialLinks={[
              {
                url: "https://web.facebook.com/mikhael.mounay.75",
                iconClass: "fa-brands fa-facebook",
              },
              { url: "", iconClass: "fa-brands fa-instagram" },
              { url: "", iconClass: "fa-solid fa-envelope" },
          ...
          />
          <TeamCard
            frontImage={AkhmetzhanNurbike}
            frontName="Akhmetzhan Nurbike"
            frontTitle="Editor in Chief"
            frontSocialLinks={[
              {
                url: "https://m.facebook.com/profile.php?id=100049304790340",
                iconClass: "fa-brands fa-facebook",
              },
              {
                url: "https://www.instagram.com/nurbikeak06_?igsh=eXc4NzVudm5qM2dh",
                iconClass: "fa-brands fa-instagram",
              },
              {
                url: "mailto:nurbikeak06@gmail.com",
                iconClass: "fa-solid fa-envelope",
              },
            ]}
            backImage={MohamedAbdelmeguid}
            backName="Mohamed Abdelmeguid"
            backTitle="Former Co-President"
            backSocialLinks={[
              {
                url: "https://www.facebook.com/muhammadehab174/",
                iconClass: "fa-brands fa-facebook",
              },
              {
                url: "https://www.instagram.com/muhammad_ehab_174/",
                iconClass: "fa-brands fa-instagram",
              },
              {
                url: "mailto:mohamedehab174@gmail.com",
                iconClass: "fa-solid fa-envelope",
              },
            ]}
          />
